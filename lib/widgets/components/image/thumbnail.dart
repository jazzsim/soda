...
import 'package:soda/widgets/components/image/image_view.dart';
...
class ImageThumbnail extends ConsumerWidget {
  ...
  const ImageThumbnail(this.file, {required this.index, super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    String imgUrl = ref.read(baseURLStateProvider) + file.filename;
